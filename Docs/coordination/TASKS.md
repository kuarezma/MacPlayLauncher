...
- **sahip:** Codex (GPT 5.5, runtime bağlamı) · **zeka:** 🔴 Maksimum · **durum:** Faz 0 done (⛔ Strategy-1 bloklu: winex11.drv yok) · Faz 0B karar bekliyor · **kapsam:** `~/Cossacks3_Mac_Port` (bu repo DIŞI)
